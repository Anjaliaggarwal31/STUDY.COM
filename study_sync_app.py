...
if menu == "📝 Register":
    ...
    with tab2:
        with st.form("teacher_form_tab"):
            tname = st.text_input("Full Name *", key="tname")
...
# Streamlit code (same as above till the 👤 Profile section)
# [Keep your existing code here till Profile section]
